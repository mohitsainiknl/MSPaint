...
public class RectangleTool {
    ...
    public static void setGraphics(Graphics2D graphics) {
        RectangleTool.graphics = graphics;
    }
    ...
    public static void draw(Point startPoint, Point endPoint, final int size) {
        if(graphics != null) {
            ...
            if(fillStroke[0] != null) {
                ...
                graphics.fillRect(startPoint.x, startPoint.y, sizePoint.x, sizePoint.y);
                color = fillColor[1];
            }
            if(fillStroke[1] != null) {
                ...
                while(gap < Math.min(sizePoint.x, sizePoint.y)) {
                    graphics.drawRect(startPoint.x + gap, startPoint.y + gap, sizePoint.x - 2*gap, sizePoint.y - 2*gap);
                    gap += size;
                }
            }
            ...
            if(lineStroke[0] != null) {
                ...
                graphics.drawRect(startPoint.x, startPoint.y, sizePoint.x, sizePoint.y);
            }
